class ConfigModel {
    ...
    ConfigModel({BusinessInfo? businessInfo, BaseUrls? baseUrls ,String? currencySymbol, String? currencyPosition, List<String>? timeZone, List<String>? permissionModule}) {
