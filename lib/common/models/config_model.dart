class ConfigModel {
  ...
  String? get currencySymbol => 'FCFA'; //_currencySymbol;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _currencySymbol = 'FCFA'; //json['currency_symbol'];
    _currencyPosition = json['currency_position'];
    _timeZones = json["time_zone"] == null
        ? []
        : List<String>.from(json["time_zone"]!.map((x) => x));
    _permissionModule = json["role"] == null
        ? []
  ...
  Map<String, dynamic> toJson() {
    ...
    data['currency_symbol'] = 'FCFA'; //_currencySymbol;
    data['currency_position'] = _currencyPosition;
