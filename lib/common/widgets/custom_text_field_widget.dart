    ...
    return TextField(
      ...
      decoration: InputDecoration(
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: ColorResources.primaryColor.withOpacity(0.5), width: 1),
        ),

        enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
            borderSide: BorderSide(color: ColorResources.primaryColor.withOpacity(0.3), width: 0.5)
        ),
        isDense: true,
        ...
        suffixIcon: widget.suffix? Container(width:Dimensions.iconSizeVerySmall,height: Dimensions.iconSizeVerySmall,
            ...
            child: Image.asset(widget.suffixIcon!, scale: 4,color: ColorResources.primaryColor,)) :widget.isPassword ? IconButton(
