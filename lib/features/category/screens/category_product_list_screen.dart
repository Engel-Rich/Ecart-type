...
import 'package:ecartify/features/product/widgets/category_item_widget.dart';
import 'package:ecartify/features/product/widgets/item_card_widget.dart';
import 'package:ecartify/features/category/widgets/product_search_dialog_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        body: Column(
          children: [
            CustomHeaderWidget(title: 'products'.tr, headerImage: Images.item),
