...
import 'package:ecartify/features/pos/domain/enums/amount_type_enum.dart';
...
import 'package:ecartify/common/models/temporary_cart_list_model.dart' as customer;
...
import 'package:ecartify/features/pos/widgets/item_price_widget.dart';
import 'package:ecartify/features/pos/widgets/confirm_purchase_dialog_widget.dart';
import 'package:ecartify/features/pos/widgets/coupon_dialog_widget.dart';
import 'package:ecartify/features/pos/widgets/customer_search_dialog_widget.dart';
import 'package:ecartify/features/pos/widgets/extra_discount_dialog_widget.dart';
import 'package:ecartify/features/pos/widgets/item_card_widget.dart';
                                        ...
                                        children: [
                                                            ...
                                                            children: [
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        ElevatedButton(
                                                                            ...
                                                                            style: ElevatedButton.styleFrom(
                                                                                backgroundColor: ColorResources.revenueCardTwoColor(),
                                                                            ...
                                                                            child: Padding(
                                                                                ...
                                                                                child: Row(
                                                                                    children: [
                                                                                        Image.asset(Images.addCustomer, width: 40, height: 40),
                                                                                    ],
                                                                                ),
                                                                            ),
                                                                        ),
                                                                ...
                                                                Row(
                                                                    ...
                                                                    children: [
                                                                            ...
                                                                            child: CustomButtonWidget(
                                                                                ...
                                                                                onPressed: (){
                                                                                    ...
                                                                                    customer.TemporaryCartListModel customerCart = customer.TemporaryCartListModel(
                                                                                        ...
                                                                                        customerName: customerId == '0'? 'ecart-${rng.nextInt(10000)}':'${customerController.customerSelectedName} ${customerController.customerSelectedMobile}',
                                                                        ...
                                                                        Expanded(
                                                                            child: CustomButtonWidget(
                                                                                buttonText: 'clear_all_cart'.tr,textColor: ColorResources.whiteColor,isClear: true,
                                                                                icon: Icons.delete,
                                                                                buttonColor: ColorResources.revenueCardOThreeColor(),
                                                                                onPressed: (){
                                            ...
                                            Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    color: ColorResources.primaryColor.withOpacity(.06),
                                                ),
                                                child: Row(
                                                    children: [
                                            ...
                                            Column(
                                                ...
                                                children: [
                                                            ...
                                                            return Container(
                                                                ...
                                                                child: Row(
                                                                    children: [
                                                                        Expanded(
                                                                            child: Text(
                                                                                transactionController.selectedFromAccountId == 0 ? 'customer_balance'.tr :
                                                                        ...
                                                                        transactionController.selectedFromAccountId == 0 ? const SizedBox():Icon(Icons.edit, color: ColorResources.primaryColor),
                                                                        GetBuilder<CartController>(
                                                                            builder: (customerController) {
                                                                                return Container(
                                                                                    decoration: BoxDecoration(
                                                                                        border: Border.all(
                                                                                            color:transactionController.selectedFromAccountId == 0 ? 
                                                                                            Theme.of(context).hintColor : Theme.of(context).secondaryHeaderColor, 
                                                                                            width: transactionController.selectedFromAccountId == 0 ? 0: 1
                                                                                        ),
                                                                                        borderRadius: BorderRadius.circular(Dimensions.paddingSizeMediumBorder),
                                                                                    ),
                                                                                    child: SizedBox(
                                                    ...
                                                    GetBuilder<TransactionController>(
                                                        builder: (transactionController) {
                                                            return transactionController.selectedFromAccountId == 0 || transactionController.selectedFromAccountId == 1 ?
                                                                Container(
                                                                    padding: const EdgeInsets.fromLTRB(
