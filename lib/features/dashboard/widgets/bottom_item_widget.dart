            ...
            child: Column(
                ...
                children: [
                    ...
                    Text(
                        name, 
                        style: TextStyle(
                            color: bottomMenuController.currentTabIndex == selectIndex ? ColorResources.primaryColor : Theme.of(context).hintColor.withOpacity(0.8),
                            fontSize: Dimensions.navbarFontSize, fontWeight: FontWeight.w600,
                        )
                    )
                ]
            ),
