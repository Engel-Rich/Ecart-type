...
import 'package:ecartify/features/product/domain/models/limite_stock_product_model.dart';
...
import 'package:ecartify/features/product/widgets/product_update_dialog_widget.dart';
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text('${product!.quantity}', style: fontSizeRegular.copyWith(color: ColorResources.primaryColor)),
            ...
            children: [
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: ColorResources.primaryColor.withOpacity(.12),
                  ),
