                  ...
                  child: Column(children: [
                    ...
                    Padding(
                      ...
                      child: Column(crossAxisAlignment : CrossAxisAlignment.start, children: [
                        Row(
                          children: [
                            Text('role'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor)),
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Padding(
                          ...
                          child: RichText(
                            text: TextSpan(
                              text: 'image'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),
                              children: <TextSpan>[
