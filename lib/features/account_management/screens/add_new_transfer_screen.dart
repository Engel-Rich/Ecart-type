                ...
                Column(children: [
                  Padding(
                    ...
                    child: Container(padding: const EdgeInsets.only(top: Dimensions.paddingSizeDefault),
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(
                          children: [
                            Text('account_from'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                  ...
                  Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(
                        children: [
                          Text('account_to'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                          Text(' *', style: fontSizeRegular.copyWith(color: Theme.of(context).secondaryHeaderColor),),
                        ],
                      ),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
