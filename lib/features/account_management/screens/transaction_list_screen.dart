...
import 'package:ecartify/features/account_management/domain/models/transaction_type_model.dart';
...
import 'package:ecartify/features/account_management/widgets/customer_transaction_list_widget.dart';
import 'package:ecartify/features/account_management/widgets/transaction_list_widget.dart';
                          ...
                          Row(crossAxisAlignment: CrossAxisAlignment.end,children: [
                                  ...
                                  return Expanded(
                                    child: Padding(
                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        Text('account'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault,0,Dimensions.paddingSizeDefault,0),
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Text('transaction_type'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                                  const SizedBox(height: Dimensions.paddingSizeSmall),
