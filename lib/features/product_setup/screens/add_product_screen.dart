...
import 'package:ecartify/features/product_setup/widgets/product_general_info_widget.dart';
import 'package:ecartify/features/product_setup/widgets/product_price_info_widget.dart';
      ...
      body: Column( children: [
        ...
        Center(
          child: Container(
            ...
            child: TabBar(
              ...
              unselectedLabelColor: ColorResources.primaryColor,
        ...
        Expanded(child: TabBarView(
          ...
          children: [
            ...
            ProductPriceInfoWidget(product: widget.product,),
          ],
        )),
      ]),
              ...
              GetBuilder<CategoryController>(builder: (categoryController) {
                return Expanded(child: CustomButtonWidget(
                  ...
                  onPressed: (){
                    ...
                    int? supplierId = Get.find<SupplierController>().selectedSupplierId ?? productController.productModel?.products?[0].supplier!.id;
