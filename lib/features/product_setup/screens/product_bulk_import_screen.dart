...
class ProductBulkImportScreen extends StatefulWidget {
  ...
  @override
  State<ProductBulkImportScreen> createState() =>
      _ProductBulkImportScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomHeaderWidget(
              title: 'bulk_import'.tr, headerImage: Images.import),
                  ...
                  child: CustomButtonWidget(
                    ...
                    onPressed: () async {
                      if (importController.selectedFileForImport != null) {
                        if (importController.checkFileExtension(fileExtensions,
                            importController.selectedFileForImport!.path)) {
                          importController.bulkImportFile();
                        } else {
                          showCustomSnackBarHelper(
                              'please_submit_correct_file'.tr);
                        }
                      } else {
