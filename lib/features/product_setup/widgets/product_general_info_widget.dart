...
import 'package:ecartify/features/brand/domain/models/brand_model.dart';
              ...
              child: SingleChildScrollView(
                child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                        ...
                        builder: (brandController) {
                          return Padding(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text('select_brand'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                    ...
                    GetBuilder<CategoryController>(
                        builder: (categoryController) {
                          return Padding(
                            padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault,0,Dimensions.paddingSizeDefault,0),
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text('select_sub_category'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                              Container(
                                height: 50,
                                padding: const EdgeInsets.symmetric(horizontal:Dimensions.paddingSizeSmall),
                    ...
                    GetBuilder<UnitController>(
                        builder: (unitController) {
                          return Padding(
                            padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault,0,Dimensions.paddingSizeDefault,0),
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text('select_unit'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault,0,Dimensions.paddingSizeDefault,0),
                      child: Text('product_image'.tr, style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
