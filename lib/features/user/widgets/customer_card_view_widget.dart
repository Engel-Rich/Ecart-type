...
import 'package:ecartify/features/user/widgets/add_balance_dialog_widget.dart';
          ...
          Row(children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.end,children: [
              ...
              InkWell(
                ...
                child: Row(children: [
                  Text('add_balance'.tr,style: fontSizeMedium.copyWith(color: ColorResources.primaryColor),),
                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                  SizedBox(width: 20,height: 20,child: Image.asset(Images.dollar,color: ColorResources.primaryColor,))
                ],),
              ):const SizedBox(),
            ],)
          ],)
