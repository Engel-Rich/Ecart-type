...
import 'package:ecartify/common/widgets/custom_date_picker_widget.dart';
...
import 'package:ecartify/features/user/widgets/purchase_dialog_widget.dart';
import 'package:ecartify/features/user/widgets/supplier_transaction_widget.dart';
                              ...
                              IntrinsicHeight(child: Row(children: [
                                  Expanded(child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: ColorResources.primaryColor.withOpacity(.05),
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        ...
                                        Text(PriceConverterHelper.priceWithSymbol(supplierController.supplierProfile!.dueAmount ?? 0),
                                          style: fontSizeBold.copyWith(color: ColorResources.primaryColor,fontSize: Dimensions.fontSizeLarge),):const SizedBox(),

                                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                        Text('due_amount'.tr, style: fontSizeMedium.copyWith(color: ColorResources.primaryColor),),
                                          ...
                                          child: Row(mainAxisAlignment: MainAxisAlignment.end,
                                            children: [
                                              ...
                                              SizedBox(width: Dimensions.iconSizeSmall,height: Dimensions.iconSizeSmall,
                                                  child: Image.asset(Images.dollar, color: ColorResources.primaryColor,)),
                                            ],
                                          ),
                                        ),
