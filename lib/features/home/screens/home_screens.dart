...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _loadData() {
    ...
    Get.find<ProductController>()
        .getLimitedStockProductList(1, isUpdate: false);
        ...
        child: RefreshIndicator(
          ...
          child: GetBuilder<ProfileController>(builder: (profileController) {
            return profileController.profileModel == null
                ...
                : (profileController.modulePermission?.dashboard ?? false)
                    ? CustomScrollView(
                        ...
                        slivers: [
                          SliverToBoxAdapter(
                            child: Column(children: [
                              ...
                              //     }
                              // ),
                              if (profileController.modulePermission?.account ??
                                  false)
                                GetBuilder<AccountController>(
                                    builder: (account) {
                                  return account.accountModel == null
                                      ? const CustomLoaderWidget()
                                      : (account.accountModel?.accountList
                                                  ?.isNotEmpty ??
                                              false)
                                          ? Column(
                                              children: [
                    ...
                    : Center(
                        ...
                        children: [
                          ...
                          Text('you_do_not_have_access_to_this_contact'.tr,
                              style: fontSizeMedium.copyWith(
