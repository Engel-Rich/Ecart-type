...
class TransactionChartWidget extends StatefulWidget {
  ...
  const TransactionChartWidget({Key? key, this.maxYExpense, this.maxYIncome})
      : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              SizedBox(
                  width: 20, height: 20, child: Image.asset(Images.pieChart)),
              const SizedBox(
                width: 5,
              ),
              Text(
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.circle,
                          size: 7, color: ColorResources.primaryColor),
                      const SizedBox(
                        width: 5,
                      ),
                      Text(
