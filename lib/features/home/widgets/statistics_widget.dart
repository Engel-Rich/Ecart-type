      ...
      child: GetBuilder<ProfileController>(builder: (profileController) {
        ...
        if (profileController.revenueModel != null) {
          ...
          itemsTitle = [
            ...
            'Base de Kutaba'.tr,
            'Base de Douala'.tr,
            'Base de Moutangene'.tr,
            'Base de Yaounde'.tr
          ];
          itemsAmount = [
            (revenue.toString()),
            '${profileController.revenueModel!.totalIncome}',
            '${profileController.revenueModel!.totalExpense}',
            '${profileController.revenueModel!.totalReceivable}',
              ...
              children: [
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    value: profileController.revenueFilterTypeIndex == 0
                        ? 'overall'
                        : profileController.revenueFilterTypeIndex == 1
                            ? 'today'
                            : 'month',
                    ...
                    onChanged: (value) {
                      ...
                      profileController.setRevenueFilterType(
                          value == 'overall'
                              ? 0
                              : value == 'today'
                                  ? 1
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: SizedBox(
                                        width: Dimensions.iconDashboardSize,
                                        height: Dimensions.iconDashboardSize,
