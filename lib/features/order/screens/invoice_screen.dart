...
import 'package:ecartify/features/order/screens/order_invoice_print_screen.dart';
                ...
                return Column(children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    Text(shopController.configModel?.businessInfo?.shopName ?? '',
                      style: fontSizeBold.copyWith(color: ColorResources.primaryColor,
                      ...
                      return orderController.invoice?.orderAmount != null ?
                        ...
                        child: Column(children: [
                          ...
                          Column(children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              Text('subtotal'.tr,style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              Text('product_discount'.tr,style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              Text('coupon_discount'.tr,style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              Text('extra_discount'.tr,style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              Text('tax'.tr,style: fontSizeRegular.copyWith(color: ColorResources.primaryColor),),
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                            Text('total'.tr,style: fontSizeBold.copyWith(color: ColorResources.primaryColor, fontSize: Dimensions.fontSizeLarge),),
