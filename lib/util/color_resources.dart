...
class ColorResources {
    ...
    static Color getRedColor() {
        return Get.isDarkMode ? const Color(0xFF334756) : const Color(0xFF1D170F);
    }
    static Color getSplashColor1() {
        return Get.isDarkMode ? const Color(0xFF334756).withOpacity(.15) : const Color(0xFF1D170F).withOpacity(.15);
    }
    ...
    ///#686868
    static const Color colorPrimary = Color(0xFF334756);
    ...
    static const Color primaryColor = Color(0xFF334756);
    static Color whiteColor = const Color(0xFFFFFFFF);
    static Color whiteK = const Color(0xFFF2F2F6);
    static Color blackColor = const Color(0xFF000000);
    static Color gradientColor = const Color(0xFF1CC083);
    ...
    static Color redColor = const Color(0xFFC20909);
